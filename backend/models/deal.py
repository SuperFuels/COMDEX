...
class Deal(Base):
    ...
    status = Column(String, default="negotiation")  # ✅ Added status column
    ...
    def __repr__(self):
        return f"<Deal(id={self.id}, buyer_email={self.buyer_email}, supplier_email={self.supplier_email}, status={self.status})>"
