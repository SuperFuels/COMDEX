...
class User(Base):
    ...
    role           = Column(String, default="buyer", nullable=False)  # roles: buyer, supplier, admin
    wallet_address = Column(String, unique=True, index=True, nullable=True)  # e.g. 0x...
    ...
    def __repr__(self):
        return (
            ...
            f"email={self.email!r}, role={self.role!r}, wallet={self.wallet_address!r})>"
        )
