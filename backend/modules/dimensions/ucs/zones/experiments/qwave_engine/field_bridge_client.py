# File: backend/modules/dimensions/ucs/zones/experiments/qwave_engine/field_bridge_client.py

"""
🌐 FieldBridge Client (Adaptive Feedback Control + Live HUD + Trend Tuning)
-----------------------------------------------------
    • Streams exhaust wave commands from SupercontainerEngine to Pi FieldBridge
...
from backend.modules.dimensions.ucs.zones.experiments.qwave_engine.field_bridge_hud import FieldBridgeHUD
...
if __name__ == "__main__":
    ...
    engine = SupercontainerEngine(container=container, safe_mode=True)
