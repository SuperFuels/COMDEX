# File: backend/modules/dimensions/ucs/zones/experiments/qwave_engine/field_bridge_ws.py

"""
🌐 FieldBridge WebSocket Server
----------------------------------------
Runs on the Raspberry Pi to:
    * Expose live PWM coil control (frequency & duty)
    * Provide ADC feedback (voltage/current sensing)
    * Enable closed-loop tuning from remote clients (e.g., MacBook SupercontainerEngine)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="FieldBridge WebSocket Server")
