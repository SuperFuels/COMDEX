...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V28_ProjectionQueryNoMaterialization.lean"
SCRIPT = ROOT / "backend" / "tests" / "glyphos_wirepack_v28_projection_query_no_materialization_benchmark.py"

OUT = LOCKDIR / "v28_projection_query_no_materialization_out.txt"
LOCK = LOCKDIR / "v28_projection_query_no_materialization_lock.sha256"
