...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V30_DeltaAggregateNoMaterialization.lean"
OUT = LOCKDIR / "v30_delta_aggregate_no_materialization_out.txt"
LOCK = LOCKDIR / "v30_delta_aggregate_no_materialization_lock.sha256"
