...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V37_HierarchicalTemplateAmortization.lean"
OUT = LOCKDIR / "v37_hierarchical_template_amortization_out.txt"
LOCK = LOCKDIR / "v37_hierarchical_template_amortization_lock.sha256"
...
def parse_lock_lines(text: str) -> dict:
    # sha256sum format: "<hash>  <path-or-basename>"
    out = {}
