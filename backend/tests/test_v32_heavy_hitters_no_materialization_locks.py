...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V32_HeavyHittersNoMaterialization.lean"
OUT = LOCKDIR / "v32_heavy_hitters_no_materialization_out.txt"
LOCK = LOCKDIR / "v32_heavy_hitters_no_materialization_lock.sha256"
