...
OUT = LOCK_DIR / "v45_crosslang_vectors_out.txt"
LOCK = LOCK_DIR / "v45_crosslang_vectors_lock.sha256"

BENCH = ROOT / "backend/tests/glyphos_wirepack_v45_crosslang_vectors_benchmark.py"
...
def test_v45_crosslang_vectors_locked() -> None:
