...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V35_DotProductNoMaterialization.lean"
OUT = LOCKDIR / "v35_dot_product_no_materialization_out.txt"
LOCK = LOCKDIR / "v35_dot_product_no_materialization_lock.sha256"
