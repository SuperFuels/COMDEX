...
print("=== Ξ₁ — Optical Lattice Realization (Tessaris) ===")
...
notes = [
    f"Optical lattice refractive profile n(x)=1.45+0.01·exp(−x²/8).",
...
plt.title("Ξ₁ — Optical Lattice Realization (Tessaris)")
plt.xlabel("x (μm)")
