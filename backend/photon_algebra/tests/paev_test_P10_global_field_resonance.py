...
for t in range(1, T):
    ...
    for i in range(M):
        ...
        merge_bias = -merge_bias_gain * np.sin(phi[i, t-1] - psi)
...
results = {
    ...
    "files": {
        "phase_plot": "PAEV_P10j_GlobalField_PhaseEvolution.png",
        "order_plot": "PAEV_P10j_GlobalField_OrderParameter.png"
    },
