    ...
    <div className="min-h-screen bg-gray-50">
      <main className="p-6 max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
          {[
            { label: "My business", value: `£${totalSalesToday}` , note: "Today's sales" },
            { label: "Products", value: activeListings, note: "Active listings" },
            { label: "Inventory", value: `${stock}/${capacity}`, note: "Stock / capacity" },
            { label: "Orders", value: openOrders, note: "Open orders" },
            { label: "Payments", value: `£${proceeds30d}`, note: "Proceeds (30d)" },
            { label: "Customers", value: feedbackRating, note: "Feedback rating" },
          ].map((c) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white shadow rounded p-4 h-48 flex items-center justify-center">Chart placeholder</div>
          <div className="bg-white shadow rounded p-4 h-48 flex items-center justify-center">Chart placeholder</div>
        </div>
