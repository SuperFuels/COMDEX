  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      <main className="flex-1 w-full">
        <div
          ref={containerRef}
          className="relative flex h-[calc(100vh-8rem)] bg-gray-50"
        >
          {/* LEFT PANE */}
          <div
          ...
          >
            ...
            <p>
              Sales Today:{' '}
              <span className="text-blue-600">{m.totalSalesToday}</span>
            </p>
            <p>
              Active Listings:{' '}
              <span className="text-green-600">{m.activeListings}</span>
            </p>
            <p>
              Open Orders:{' '}
              <span className="text-green-600">{m.openOrders}</span>
            </p>
            <p>
              30d Proceeds:{' '}
              <span className="text-blue-600">£{m.proceeds30d}</span>
            </p>
            <p>
              Feedback:{' '}
              <span className="text-purple-600">{m.feedbackRating}</span>
            </p>
          ...
          {/* RIGHT PANE */}
          <div
            className="absolute top-0 bg-white overflow-auto p-4"
            style={{
              left: dividerX,
          ...
          >
            {searchResults ? (
              ...
              <div className="h-full flex items-center justify-center text-gray-500">
                <p>
                  Select a tab or ask a question to see visual output
                  here.
                </p>
              </div>
            )}
      ...
      {/* BOTTOM BAR */}
      <footer className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-2 flex items-center">
