...
const Home: NextPage = () => {
  ...
  // 2) Build chart data from the selected product price
  ...
  if (error) return <p className="p-8 text-center text-red-500">Failed to load</p>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-6 px-4 py-6">
        ...
        <aside className="col-span-12 md:col-span-3 space-y-6">
          ...
          {selected && (
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 space-y-2">
              ...
              <p className="text-3xl font-bold">
                ...
                >
                  {selected.change_pct >= 0 ? '↑' : '↓'}{' '}
                  {Math.abs(selected.change_pct).toFixed(2)}%
                </span>
              </p>
              {/* share / social icons */}
          ...
          {/* Country filters */}
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4">
            <h3 className="text-lg font-medium mb-2">Top Buyers / Sellers</h3>
