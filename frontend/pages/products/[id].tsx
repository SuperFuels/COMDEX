      ...
      <div className="max-w-7xl mx-auto bg-white shadow rounded-lg overflow-hidden">
        ...
        <nav className="px-6 py-3 text-sm text-gray-600" aria-label="Breadcrumb">
          <ol className="flex space-x-2">
            <li>
              <Link legacyBehavior href="/" className="hover:underline">Home</Link>
              <span className="mx-2">/</span>
            </li>
            <li>
              <Link legacyBehavior href={`/category/${product.category}`} className="hover:underline">
                {product.category}
              </Link>
              <span className="mx-2">/</span>
            </li>
        ...
        <div className="px-6 pb-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="flex items-baseline space-x-2">
              ...
              <span className={`text-sm font-medium ${product.change_pct >= 0 ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <aside className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-gray-50 p-4 rounded border text-center">
              ...
              <p className="font-medium text-gray-900">{product.rating.toFixed(1)}/5</p>
            </div>
          </aside>
        </div>
      </div>
