    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto bg-white shadow rounded-lg overflow-hidden">
        ...
        <div className="px-6 pb-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <button
                ...
                className="w-full py-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium rounded"
              >
                Order Sample
              </button>
              <button
                onClick={() => router.push(`/products/${product.id}/zoom`)}
                className="w-full py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded"
              >
                Setup Zoom Call
              </button>
            </div>
            ...
            {/* Share */}
            <div className="flex space-x-4 text-gray-500 pt-4">
          ...
          {/* Sidebar Info (“Buy Box” style) */}
          <aside className="lg:col-span-2 space-y-4">
            <div className="bg-gray-50 p-4 rounded border text-center space-y-2">
              <p className="text-sm text-gray-600">Origin</p>
              <p className="font-medium text-gray-900">{product.origin_country}</p>
            </div>
            <div className="bg-gray-50 p-4 rounded border space-y-2 text-center">
