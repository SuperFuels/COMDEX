...
const modulationStrategy = latestGlyph?.modulation_strategy as ModulationStrategy;
...
{modulationMeta && (
  <div className="absolute top-2 right-2 bg-gray-900/80 px-3 py-1 rounded-md shadow-md border border-purple-700 text-sm flex items-center gap-2 z-50">
    <span className="text-lg">{modulationMeta.emoji}</span>
    <div className="text-white">
      <div className="font-semibold">{modulationMeta.label}</div>
