  ...
  return (
    <section className="space-y-16">
      ...
      <div className="text-center space-y-6">
        ...
        {/* ✅ FAIR LAUNCH COUNTDOWN (added, no truncation below) */}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="text-left">
                  <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-[0.22em] text-blue-700">
                    ...
                    <span
                      className={
                        live ? "h-2 w-2 rounded-full bg-emerald-500" : "h-2 w-2 rounded-full bg-blue-500 animate-pulse"
                      }
                    />
                  </div>
            ...
            <div className="rounded-[2.25rem] border border-slate-200 bg-white p-6 sm:p-10 space-y-10">
              ...
              <div className="space-y-3">
                ...
                <p className="text-slate-700 leading-relaxed">
                  ...
                  Most software communicates by shipping huge JSON/XML payloads full of redundant keys and repeated structure.
                </p>
              </div>
...
⊕ doc("Q3") → extract(rev, exp, profit) → sum(5)`}
                  ...
                  <div className="mt-3 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900 leading-relaxed">
                    ...
                    <span className="font-semibold">7× smaller.</span> And it improves as operations get more complex.
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="rounded-2xl border border-slate-200 bg-white p-5">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Instead of megabytes of verbose instructions, edge devices receive kilobytes of glyphs. That makes more AI
                      operations feasible without cloud round-trips.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-5">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Factories and sensor grids can ship more updates on the same bandwidth because the redundant structure is
                      removed.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-5">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Every glyph produces a deterministic trace — run it twice and you get the same outputs byte-for-byte. That
                      turns “logs” into provable execution.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-5">
                    ...
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Less bandwidth, less compute churn, and fewer round-trips. The bigger the agent network, the more this
                      compounds.
                    </p>
                  </div>
                </div>
...
deterministic ✓ (same glyph tomorrow → same bytes)`}
              ...
              <div className="rounded-[2rem] border border-blue-200 bg-blue-50 p-6">
                <div className="text-[11px] uppercase tracking-[0.22em] text-blue-700 font-bold">What’s live today</div>
                <ul className="mt-3 text-sm text-blue-900 leading-relaxed list-disc pl-5 space-y-1">
                  <li>
                    <span className="font-semibold">GlyphOS Alpha</span> — execution engine running
                  </li>
                  <li>
                    <span className="font-semibold">Compression benchmarks</span> — reproducible gains on complex programs
                  </li>
                  <li>
                    <span className="font-semibold">WirePack v10</span> — template + delta transport
                  </li>
                  <li>
                    <span className="font-semibold">Deterministic locks</span> — SHA256-verified artifacts
                  </li>
                </ul>
            ...
            <div className="rounded-[2.25rem] border border-slate-200 bg-gradient-to-b from-slate-50 to-white p-6 sm:p-10 space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-slate-600 leading-relaxed">
                  ...
                  templates + deltas, plus proof-grade replay.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-5">
                ...
                <ul className="mt-2 text-sm text-slate-600 leading-relaxed list-disc pl-5 space-y-1">
                  <li>
                    <span className="font-semibold text-black">60× less bandwidth</span> on complex programs
                  </li>
                  <li>
                    <span className="font-semibold text-black">edge devices become intelligent</span>
                  </li>
                  <li>
                    <span className="font-semibold text-black">audit trails become verifiable</span>
                  </li>
                  <li>
                    <span className="font-semibold text-black">enterprise saves infrastructure cost</span>
                  </li>
                </ul>
              </div>
