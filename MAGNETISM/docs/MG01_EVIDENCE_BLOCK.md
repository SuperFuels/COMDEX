...
Pinned_Runs:
  - MG01 tessaris_flux_hold:   <PUT_HASH_HERE>
  - MG01 open_loop:           <PUT_HASH_HERE>
  - MG01 random_jitter_kappa: <PUT_HASH_HERE>

Results (from run.json):
  - Tessaris: ang_err_final=..., b_final=[..., ...], b_target=[1.0, 0.0], kappa_initial=..., kappa_final=...
  - Open-loop: ang_err_final=..., b_final=[..., ...]
  - Random jitter: ang_err_final=..., b_final=[..., ...]
