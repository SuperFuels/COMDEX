...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V34_HistogramNoMaterialization.lean"
OUT = LOCKDIR / "v34_histogram_no_materialization_out.txt"
LOCK = LOCKDIR / "v34_histogram_no_materialization_lock.sha256"
