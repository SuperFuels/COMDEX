...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V31_TopKWithinQNoMaterialization.lean"
OUT = LOCKDIR / "v31_topk_within_q_no_materialization_out.txt"
LOCK = LOCKDIR / "v31_topk_within_q_no_materialization_lock.sha256"
