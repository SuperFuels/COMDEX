...
LEAN = ROOT / "backend" / "modules" / "lean" / "workspace" / "SymaticsBridge" / "V29_ProjectionQueryKNoMaterialization.lean"
OUT = LOCKDIR / "v29_projection_query_k_no_materialization_out.txt"
LOCK = LOCKDIR / "v29_projection_query_k_no_materialization_lock.sha256"
